...
اگر دقت کنید در لیست اولیه، \m{straw} قبل از \m{spork} آمده بود و در لیست مرتب شده هم همین ترتیب حفظ شد. به این نگهداری ترتیب اولیه‌ی عناصر، پایداری الگوریتم مرتب‌سازی می‌گویند.
